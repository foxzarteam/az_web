      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4 h-16 sm:h-20">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-midnight_text dark:text-white">
            {mounted && (
              <button
                ...
                className="flex h-8 w-8 items-center justify-center p-0 border-0 bg-transparent cursor-pointer rounded"
              >
                <svg viewBox="0 0 16 16" className="h-6 w-6 dark:hidden" fill="currentColor" aria-hidden>
                ...
                <svg viewBox="0 0 23 23" className="h-6 w-6 hidden dark:block" fill="currentColor" aria-hidden>
          ...
          <button
            ...
            className="block lg:hidden p-2 rounded-lg text-midnight_text dark:text-white"
            aria-label="Toggle mobile menu"
          >
            <span className="block w-6 h-0.5 bg-current mt-0" />
