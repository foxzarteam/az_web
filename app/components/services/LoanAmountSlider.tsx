...
export default function LoanAmountSlider({
  ...
  return (
    <div>
      <label htmlFor={`${id}-input`} className="mb-3 block text-sm font-medium text-midnight_text dark:text-gray-300">
        Select Loan Amount *
      </label>
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        {/* Amount input */}
        <div className="w-[132px] shrink-0 sm:w-[156px]">
          <div className="rounded-2xl border border-[#E2E8F0] bg-white px-2.5 py-2 shadow-[0_2px_12px_rgba(16,45,71,0.06)] dark:border-dark_border dark:bg-darkmode sm:px-3 sm:py-2.5">
            <input
              id={`${id}-input`}
              type="text"
              inputMode="numeric"
            ...
            />
            <div className="mx-auto mt-1 h-[2.5px] w-[70%] rounded-full bg-primary" aria-hidden />
          </div>
        </div>
      </div>
    </div>
