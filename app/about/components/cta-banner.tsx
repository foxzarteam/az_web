  ...
  return (
    <section className="bg-white !pt-0 dark:bg-darkmode">
      <div className="container mx-auto max-w-full px-4 sm:px-6 md:max-w-screen-md lg:max-w-screen-xl lg:px-8">
        <div
          className="flex flex-col items-center gap-6 overflow-hidden rounded-2xl bg-[#FFF1E7] px-5 py-6 dark:bg-darklight sm:px-8 lg:flex-row lg:items-center lg:gap-8 lg:py-0"
          data-aos="fade-up"
        >
          ...
          <div className="flex w-full flex-col gap-3 pb-6 xs:w-auto xs:flex-row sm:gap-4 lg:shrink-0 lg:py-8 lg:pb-8">
            <Link
