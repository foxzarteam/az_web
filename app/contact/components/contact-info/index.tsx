...
export default function ContactInfo() {
  return (
    <section className="dark:bg-darkmode pt-6 sm:pt-8 pb-0 px-4 sm:px-6">
      <div className="container mx-auto w-full min-w-0 max-w-full lg:max-w-screen-xl md:max-w-screen-md">
        <div className="flex md:flex-row flex-col lg:items-center items-start justify-center md:gap-12 lg:gap-28 gap-6 sm:gap-8">
          <div className="flex sm:flex-row flex-col items-start sm:gap-6 md:gap-8 gap-4 w-full min-w-0 md:flex-1">
