        ...
        <div className="grid grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="md:col-span-8 col-span-12 grid grid-cols-12 gap-6 sm:gap-8">
            <div className="lg:col-span-4 col-span-12">
              <h4 className="mb-3 sm:mb-4 text-base sm:text-lg text-white">Address</h4>
              <p className="mb-4 sm:mb-6 text-gray text-sm sm:text-base leading-relaxed">
            ...
            <div className="lg:col-span-4 col-span-6 sm:col-span-6">
              ...
              <ul className="space-y-2">
                <li><Link href="/contact" className="inline-block py-1.5 text-sm sm:text-base text-gray hover:text-white min-h-[44px] flex items-center">Contact</Link></li>
                <li><Link href="/#featured" className="inline-block py-1.5 text-sm sm:text-base text-gray hover:text-white min-h-[44px] flex items-center">Service</Link></li>
                <li><Link href="/about" className="inline-block py-1.5 text-sm sm:text-base text-gray hover:text-white min-h-[44px] flex items-center">About</Link></li>
              </ul>
            </div>
            <div className="lg:col-span-4 col-span-6 sm:col-span-6">
              <h4 className="mb-3 sm:mb-4 text-base sm:text-lg text-white">Popular</h4>
              <ul className="space-y-2">
                <li><Link href="/#featured" className="inline-block py-1.5 text-sm sm:text-base text-gray hover:text-white min-h-[44px] flex items-center">Personal Loan</Link></li>
                <li><Link href="/#featured" className="inline-block py-1.5 text-sm sm:text-base text-gray hover:text-white min-h-[44px] flex items-center">Insurance</Link></li>
                <li><Link href="/#featured" className="inline-block py-1.5 text-sm sm:text-base text-gray hover:text-white min-h-[44px] flex items-center">Credit Card</Link></li>
              </ul>
            </div>
          </div>
        </div>
